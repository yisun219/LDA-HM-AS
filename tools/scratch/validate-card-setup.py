#!/usr/bin/env python3
"""Validate one card's full setup + selfchecks in one sandbox."""
import sys, time
...
card = _card(Path(sys.argv[1] if len(sys.argv) > 1 else "/fact_data/yisun/LDA-HM/examples/libcairo2-card.json"))
